...
export default function MemeGenerator() {
 ...
 const downloadMeme = async () => {
  ...
  const reset = () => { setStage("input"); setPrompt(""); setSuggested([]); setSelected(null); };
  ...
  return (
    <div style={{ fontFamily:"'Inter',system-ui,sans-serif", background:"#0A0A0A", minHeight:"100vh", color:"#fff" }}>
      ...
      {/* INPUT */}
      {stage==="input" && (
        <div style={{maxWidth:680,margin:"0 auto",padding:"56px 24px 80px"}} className="fade-up">
          <div style={{textAlign:"center",marginBottom:48}}>
            ...
            <p style={{color:"#555",marginTop:18,fontSize:15}}>Powered by Groq AI · 14 Languages · Instagram-ready · 100+ Templates</p>
          </div>
          ...
          <div style={{position:"relative",marginBottom:16}}>
            <textarea value={prompt} onChange={e=>setPrompt(e.target.value)}
              ...
              style={{padding:"20px",fontSize:15,minHeight:140,resize:"vertical",lineHeight:1.6}}/>
      ...
      {stage==="results" && (
        <div style={{maxWidth:1020,margin:"0 auto",padding:"40px 24px"}} className="fade-up">
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:16,marginBottom:32}}>
            {suggested.map((t,i)=>(
              <div key={t.id} className="tc" onClick={()=>{setSelected(t);setStage("edit")}}>
      ...
      {stage==="edit" && selected && (
        <div style={{maxWidth:1100,margin:"0 auto",padding:"40px 24px 60px"}} className="fade-up">
          <div style={{display:"flex",alignItems:"center",gap:16,marginBottom:32,flexWrap:"wrap"}}>
            <button className="btn-g" onClick={()=>setStage("results")} style={{padding:"10px 18px",fontSize:13}}>← Back</button>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:32}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:20}}>
              ...
              <div style={{background:"#fff",borderRadius:14,overflow:"hidden",maxWidth:360,margin:"0 auto",boxShadow:"0 20px 60px rgba(0,0,0,.5)"}}>
                ...
                <div className="mw">
                  <img src={selected.url} alt="preview" style={{width:"100%",display:"block"}}/>
                ...
                <div style={{padding:"10px 16px 14px"}}>
                  ...
                  <div style={{fontSize:13,color:"#111",marginTop:4,lineHeight:1.55}}>
                    <span style={{fontWeight:700}}>memecraft_ai </span>{caption}
                  </div>
              ...
              <div className="card" style={{padding:20}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
                  ...
                  <button className="btn-g" onClick={regenCaption} style={{padding:"5px 12px",fontSize:11}}>🔄 Regenerate</button>
                </div>
                <textarea value={caption} onChange={e=>setCaption(e.target.value)} style={{padding:"10px 14px",fontSize:13,minHeight:80,resize:"vertical",lineHeight:1.6}}/>
